...
function removeZero(){ // 계산결과 출력시 맨 앞의 0 제거 함수
...
function fordisplay(value) { // 버튼을 클릭한 숫자가 이어서 출력되게 하는 함수
    removeZero()
    document.getElementById("output").innerHTML += value; //+- 우측의 연산자의 값을 변수에 더하는 연산자
